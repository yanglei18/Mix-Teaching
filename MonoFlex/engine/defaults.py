...
def default_argument_parser():
    ...
    parser.add_argument("--mix_teaching", type=bool, default=False, help="if applying semi-supervised training")
    ...
    parser.add_argument("--ckpt",
        type=str, default="", help="The path to the checkpoint for test, default is the latest checkpoint")
    parser.add_argument("--labeled_ratio", type=float, default=1.0, help="ratio of training set used for training")
